...
export interface _SERVICE {
  ...
  'saveJob' : ActorMethod<[string, number, boolean, [] | [string], number, number, Array<JobLineItem>, Array<WeldingLineItem>, number, number, number], SavedJob>,
  'updateJob' : ActorMethod<[string, string, number, boolean, [] | [string], number, number, Array<JobLineItem>, Array<WeldingLineItem>, number, number, number], SavedJob>,
  ...
  'saveFlexibleJob' : ActorMethod<[string, string, number, number, number, number, bigint, boolean, number, number, number, bigint, bigint, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number], FlexibleJob>,
  'updateFlexibleJob' : ActorMethod<[string, string, string, number, number, number, number, bigint, boolean, number, number, number, bigint, bigint, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number], FlexibleJob>,
