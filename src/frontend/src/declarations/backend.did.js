...
export const idlFactory = ({ IDL: _IDL }) => {
  ...
  const MachinedLineItem = _IDL.Record({
    'opType' : _IDL.Text,
    'drillDia' : _IDL.Float64,
    'matThickness' : _IDL.Float64,
    'grade' : _IDL.Text,
    'numberOfDrills' : _IDL.Nat,
    'costPerDrill' : _IDL.Float64,
    'weightRemoved' : _IDL.Float64,
    'description' : _IDL.Text,
    'qty' : _IDL.Nat,
    'costPerUnit' : _IDL.Float64,
  ...
  const SavedJob = _IDL.Record({
    ...
    'machinedLineItems' : _IDL.Vec(MachinedLineItem),
    'ratePerKg' : _IDL.Float64,
  ...
  return _IDL.Service({
    ...
    'saveJob' : _IDL.Func([_IDL.Text, _IDL.Float64, _IDL.Bool, _IDL.Opt(_IDL.Text), _IDL.Float64, _IDL.Float64, _IDL.Vec(JobLineItem), _IDL.Vec(WeldingLineItem), _IDL.Vec(MachinedLineItem), _IDL.Float64, _IDL.Float64, _IDL.Float64], [SavedJob], []),
    'updateJob' : _IDL.Func([_IDL.Text, _IDL.Text, _IDL.Float64, _IDL.Bool, _IDL.Opt(_IDL.Text), _IDL.Float64, _IDL.Float64, _IDL.Vec(JobLineItem), _IDL.Vec(WeldingLineItem), _IDL.Vec(MachinedLineItem), _IDL.Float64, _IDL.Float64, _IDL.Float64], [SavedJob], []),
